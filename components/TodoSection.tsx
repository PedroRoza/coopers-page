...
function TodoItem({
  ...
  return (
    <div
      ...
      className={`flex items-center p-2 mb-2 border-b border-gray-200 group ${
      ...
      <button
        ...
        className={`w-8 h-8 mr-3 rounded-full flex items-center justify-center transition-colors duration-200
          ${
            item.completed
              ? "bg-green-500"
              : "bg-white-500 border-2 border-orange-500"
          }`}
      ></button>
...
export default function TodoSection() {
  ...
  useEffect(() => {
    const fetchTodos = async () => {
      try {
        ...
        setCompletedItems(
          mappedTodos.filter((todo: TodoItem) => todo.completed)
        );
      } catch (error) {
  ...
  const updateItemContent = (id: number, content: string) => {
    setTodoItems(
      todoItems.map((item) => (item.id === id ? { ...item, content } : item))
    );
  };
          ...
          <DndProvider backend={Backend}>
            <div className="md:w-1/2 bg-white text-black rounded-md shadow-lg">
              ...
              <div className="p-6 pt-4">
                <h1 className="flex justify-center font-bold mb-2 text-6xl">
                  To-do
                </h1>
                <p className="text-gray-600 flex justify-center text-xl">
                  Take a breath.
                </p>
                <p className="text-gray-600 flex justify-center mb-4 text-xl">
                  Start doing.
                </p>
            ...
            <div className="w-full md:w-1/2 bg-white text-black rounded-md  shadow-lg">
              ...
              <div className="pt-4 p-6">
                <h3 className="flex justify-center font-bold mb-2 text-6xl">
                  Done
                </h3>
                <p className="text-gray-600 flex justify-center text-xl">
